...
'Cyganka przepowiada Michałowi niezwykłe przeżycia. Początkowo mężczyzna nie bierze poważnie tych proroctw.',
...
'Ryszard Ochódzki stara się przeniknąć do struktur Solidarności. W wyniku zbiegu okoliczności sam ucieka przed milicją. ',
...
'Gorzka komedia o Adasiu Miauczyńskim, poloniście, który nie potrafi wyrwać się z nudy dnia codziennego.',
...
'Załoga statku kosmicznego Nostromo odbiera tajemniczy sygnał i ląduje planetoidzie. Załoga zostaje zaatakowana przez obcą formę życia.',
...
'Dr Emmett Brown buduje wehikuł czasu. Jego przyjaciel Marty przenosi się w lata 50. i niechcący przeszkadza w poznaniu się swoim rodzicom.',
...
'Dr Emmett Brown wysyła Marty`ego i Jennifer do roku 2015, by zapobiegli rozpadowi swojej przyszłej rodziny.',
...
'Terroryści opanowują korporacyjny wieżowiec. Może ich powstrzymać tylko jeden policjant, John McClane.',
...
'Haker Neo dowiaduje się, że świat, w którym żyje, jest tylko obrazem przesyłanym do jego mózgu przez roboty.',
...
'Szaleniec strzela do ludzi z dachów i szantażuje burmistrza. Może go unieszkodliwić jedynie inspektor Callahan.',
...
'Agent nieruchomości wyrusza w podróż, aby podpisać umowę o zakupie posiadłości. Nieświadomie udaje się do zamku wampira.',
