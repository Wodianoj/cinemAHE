...
INSERT INTO cahe_movie (id, title, year, genre_id, path_to_picture, description)
VALUES
(1, 'Miś', 1980, 4, '../images/movies/Miś.png'
...
(2, 'Brunet wieczorową porą', 1976, 4, '../images/movies/BrunetWieczorowaPora.png'
...
(3, 'Rozmowy kontrolowane', 1991, 4, '../images/movies/RozmowyKontrolowane.png'
...
(4, 'Dzień świra', 2002, 4, '../images/movies/DzienSwira.png'
...
(5, 'Obcy - 8. pasażer “Nostromo”', 1979, 5, '../images/movies/Obcy.png'
...
(6, 'Powrót do przyszłości', 1985, 5, '../images/movies/BackToTheFuture.png'
...
(7, 'Powrót do przyszłości II', 1989, 5, '../images/movies/BackToTheFuture2.png'
...
(8, 'Szklana pułapka', 1988, 2, '../images/movies/DieHard.png'
...
(9, 'Matrix', 1999, 2, '../images/movies/Matrix.jpg'
...
(10, 'Brudny Harry', 1971, 2, '../images/movies/BrudnyHarry.png'
...
(11, 'Nosferatu - symfonia grozy', 1922, 1, '../images/movies/Nosferatu.png'
...
(12, 'Lśnienie', 1980, 1, '../images/movies/Lsnienie.png'
