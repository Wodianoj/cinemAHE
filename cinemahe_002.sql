...
VALUES
    (1, 'Cinemahe Łódź', 'ul. Krakowska 71, 40-440 Łódź', 'cinemahe@lodz.pl', '+48 887 552 311', '../images/cinemas/lodz.jpg'),
	(2, 'Cinemahe Kraków', 'ul. Łódzka 17, 20-220 Kraków', 'cinemahe@kraków.pl', '+48 113 335 788', '../images/cinemas/krakow.jpg');
...
INSERT INTO cahe_movie (id, title, year, genre_id, wide_image, thin_image, short_description ,description)
VALUES
(1, 'Miś', 1980, 4, '../images/movies/mis.jpg', '../images/movies/mis_thin.png',
'Pełne paradoksów i komizmu życie prezesa klubu sportowego czasach PRL-u.',
...
(2, 'Brunet wieczorową porą', 1976, 4, '../images/movies/BrunetWieczorowaPora.jpg', '../images/movies/brunet_thin.png',
'Cyganka przepowiada Michałowi przyszłość, mężczyzna nie bierze tego poważnie.',
...
(3, 'Rozmowy kontrolowane', 1991, 4, '../images/movies/RozmowyKontrolowane.jpg','../images/movies/rozmowy_thin.png',
'Skutkiem słabości do kobiet Ryszard wpada w kłopoty ',
...
(4, 'Dzień świra', 2002, 4, '../images/movies/DzienSwira.jpg','../images/movies/DzienSwira.png',
'Gorzka komedia o Adasiu, poloniście schwytanym w pułapkę dnia codziennego.',
...
(5, 'Obcy - 8. pasażer “Nostromo”', 1979, 5, '../images/movies/Obcy.jpg','../images/movies/Obcy.png',
'Załoga statku kosmicznego odbiera tajemniczy sygnał, podążając za nim, natrafia obcą formę życia.',
...
(6, 'Powrót do przyszłości', 1985, 5, '../images/movies/BackToTheFuture.jpg', '../images/movies/BackToTheFuture.png',
'Emmett Brown buduje wehikuł czasu i wraz z przyjacielem Martym przenosi się w lata 50.',
...
(7, 'Powrót do przyszłości II', 1989, 5, '../images/movies/BackToTheFuture2.jpg','../images/movies/BackToTheFuture2.png',
'Emmett Brown wysyła Marty`ego i Jennifer w przyszłość, by zapobiec rodzinnej tragedii.',
...
(8, 'Szklana pułapka', 1988, 2, '../images/movies/DieHard.jpg', '../images/movies/DieHard.png',
'Terroryści opanowują korporacyjny wieżowiec, tylko John McClane może ich powstrzymać.',
...
(9, 'Matrix', 1999, 2, '../images/movies/Matrix.jpg', '../images/movies/Matrix.png',
'Haker Neo dowiaduje się, że świat, w którym żyje, jest tylko projekcją.',
...
(10, 'Brudny Harry', 1971, 2, '../images/movies/BrudnyHarry.jpg', '../images/movies/BrudnyHarry.png',
'Szaleniec strzela do ludzi i szantażuje burmistrza. Tylko inspektor Callahan może go zatrzymać.',
...
(11, 'Nosferatu - symfonia grozy', 1922, 1, '../images/movies/Nosferatu.jpg', '../images/movies/Nosferatu.png',
'Agent nieruchomości wyrusza w podróż, aby podpisać umowę. Nie wie, że udaje się do zamku wampira.',
...
(12, 'Lśnienie', 1980, 1, '../images/movies/Lsnienie.jpg', '../images/movies/Lsnienie.png',
'Jack podejmuje pracę stróża w hotelu Overlook. Wkrótce idylla zamienia się w koszmar.',
